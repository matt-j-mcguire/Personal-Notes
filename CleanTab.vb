...
#Region "Properties"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <Category("Appearance"), DefaultValue("Color.SteelBlue")>
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <Category("Appearance"), DefaultValue("Color.White")>
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    <Category("Appearance"), DefaultValue("Color.Gray")>
...
#Region "tab Drawing"
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using xstrf As New StringFormat()
            ...
            For i As Integer = 0 To _tabs.Count - 1
                Dim sz As SizeF = e.Graphics.MeasureString(_tabs(i).TabText, Me.Font)
                Dim r As New Rectangle(l, 0, sz.Width + 32, 24)
                ...
                Using fc As New SolidBrush(Me.ForeColor)
                    ...
                    Dim tx As String = _tabs(i).TabText & If(_tabs(i).DirtyBit, "*", "")
...
#End Region
    ...
    Protected Overrides Sub OnMouseClick(e As MouseEventArgs)
        ...
        For i As Integer = 0 To _tabs.Count - 1
            ...
            If r.Contains(e.X, e.Y) Then
                If _tabs(i).CloseRec.Contains(e.X, e.Y) Then
    ...
    Protected Overrides Sub OnMouseDown(e As MouseEventArgs)
        ...
        If _droparrowRec.Contains(e.X, e.Y) AndAlso e.Button = MouseButtons.Left Then
        ...
        ElseIf Menu IsNot Nothing AndAlso _menuDropRec.Contains(e.X, e.Y) AndAlso e.Button = MouseButtons.Left Then
            Menu.Show(Me, _menuDropRec.X, _menuDropRec.Bottom)
        ElseIf e.Button = MouseButtons.Right AndAlso TabRclickMenu IsNot Nothing Then
            For i As Integer = 0 To _tabs.Count - 1
...
#Region "properites"
        ...
        Public Overridable ReadOnly Property TabText
            Get
                Return Me.Text
            End Get
        End Property
